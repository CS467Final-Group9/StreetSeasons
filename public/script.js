...
(function() {
  var margin = {top: 30, right: 20, bottom: 100, left: 50},
    ...
    width    = 764*1.1 - margin.left - margin.right,
    height   = 283*1.5 - margin.top - margin.bottom,
    height2  = 283*1.5 - margin2.top - margin2.bottom;
  ...
  focus.append("linearGradient")
    ...
    var helper = focus.append('g')
      ...
      .style('text-anchor', 'end')
      .attr('transform', 'translate(' + (width-480) + ', 350)');
